...
**Usage:** After each episode is complete, rate it on all dimensions. Record ratings in `/podcast/episodes/YYYY-MM-DD-slug/logs/quality_scorecard.md`.
...
Copy this template to `/podcast/episodes/YYYY-MM-DD-slug/logs/quality_scorecard.md` for each episode.
