...
description: Automate ChatGPT Deep Research using Chrome DevTools. Use for Phase 3 industry analysis, case studies, and technical documentation research. Handles browser automation, 5-10 min wait with polling, and result extraction. Returns industry-focused research ready to paste into research-results.md.
---
