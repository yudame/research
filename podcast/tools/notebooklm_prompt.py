...
Usage:
    ...
    python notebooklm_prompt.py ../episodes/YYYY-MM-DD-slug/ --series "Series Name"
"""
            ...
            for line in f:
                if line.startswith("| **Series**"):
                    ...
                    if len(parts) >= 3:
                        ...
                        if series and series.lower() not in ["none", "standalone", "n/a", ""]:
                            return series

    # Check if path contains a series folder
    # e.g., podcast/episodes/stablecoin-series/episode-5-xxx
...
def main():
    ...
    parser.add_argument(
        "--copy",
        action="store_true",
        help="Copy prompt to clipboard (macOS only)"
    )
