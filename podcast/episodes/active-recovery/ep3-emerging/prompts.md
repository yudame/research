# Research and Generation Prompts

## Episode: Active Recovery: Ep. 3, Emerging Edges
...
```
Modern podcast episode cover art for "Ep3 Emerging":
...
Concept: Here is a finding that should give every fitness enthusiast pause: interventions that dramatically improve your biomarkers often fail to enhance your actual performance. That expensive pneumatic compr
...
**Enhanced Prompt (with system constraints):**
```
Modern podcast episode cover art for "Ep3 Emerging":
...
- Episode: Ep. 3 - Emerging Edges
- Border: 20px, #FFC20E

**Model:** google/gemini-3-pro-image-preview
**Aspect Ratio:** 1:1
**Final Dimensions:** 1064x1064px (with 20px yellow border)
**File Size:** 1.4MB
