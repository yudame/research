...
**Subtitle:** The Science of Letting Go: Why Everything You Know About Delegation Is Probably Wrong

## Audio

- **File:** how-to-delegate.mp3
- **Duration:** 46:32
- **File size:** 44,679,984 bytes (42.6 MB)
- **Bitrate:** 128 kbps
- **Sample rate:** 44100 Hz
- **Channels:** Stereo
- **Chapters:** 13 (embedded)
...
- **Perplexity:** 51KB comprehensive academic research
- **Claude:** 24KB critical analysis
- **GPT-Researcher:** Industry/technical synthesis
- **Grok:** X/Twitter discourse analysis
- **Gemini:** Not completed (API timeout)
...
- **Audio source:** NotebookLM (manual generation)
- **Original format:** m4a (86 MB)
- **Transcription:** Local Whisper (base model), 8,659 words
- **Chapter generation:** Manual (from transcript analysis)
- **Cover art:** AI-generated via Gemini (OpenRouter) + Yudame branding
