...
- `<itunes:owner>` with name="Valor Engels" and email="valor@yudame.org" ✓
- `<itunes:explicit>` = "no" ✓
...
- `<enclosure>` present:
  - url = "https://research.bwforce.ai/podcast/episodes/stablecoin-series/ep8-post-launch-operations/2026-02-04-post-launch-operations.mp3" ✓
...
- Report link included: ✅ https://research.bwforce.ai/podcast/episodes/stablecoin-series/ep8-post-launch-operations/report.md
...
**Episode is ready for publication at:** https://research.bwforce.ai/podcast/feed.xml
